...
const convertUserDataToPdf=async (userData)=>{
    ...
    doc.fontSize(14).text(`Email:${userData.bio}`);
    doc.fontSize(14).text(`Email:${userData.currentPost}`);

    doc.fontSize(14).text("Past Work: ")
    userData.pastWork.forEach((work,index)=>{
        doc.fontsize(14).text(`Company Name:${work.company}`);
        doc.fontsize(14).text(`Company Name:${work.position}`);
        doc.fontsize(14).text(`Company Name:${work.years}`)
    })
    doc.end();
    return outputPath;
